<template>
    <div class="content">
        <div>
            ...
            <li><a href="https://www.bilibili.com/video/BV1cS4y1d7hf" target="_blank">LibEpidemic Presentation(P1)</a> and <a href="https://www.bilibili.com/video/BV1ab4y187Dr" target="_blank">LibEpidemic Tutorial(P2)</a> has been uploaded to bilibili (in Chinese).</li>
            <br>
        </div>
        ...
        <div>
            <br>
            <p> Below is the demonstration video of LibEpidemic. </p>
