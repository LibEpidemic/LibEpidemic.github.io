<template>
    <div class="content">
        <div>
            <br>
            <p class="title">LibEpidemic: An Open Library for Traffic Prediction</p>
            <p><a :href="`${path}LibCity_An_Open_Library_for_Traffic_Prediction.pdf`" download="LibCity_An_Open_Library_for_Traffic_Prediction.pdf">[Download]</a> <a href="https://dl.acm.org/doi/10.1145/3474717.3483923" target="_blank">[Official Link]</a> <a href="https://github.com/Bigscity-epidemic/Epidemic-Modeling-survey" target="_blank">[Code]</a></p>
